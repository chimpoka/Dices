...
public class Die : MonoBehaviour {
    ...
    private bool localHit
    {
        get
        {
			...
			// В теории этого никогда не случится
            return false;
        }
    }

	// Считает значение на кубике
    private void GetValue()
    {
        ...
        do
        {
            ...
            side++;
            // Если то мы проверили все стороны, то (testHitVector == Vector3.zero)
        } while (testHitVector != Vector3.zero);
    }

    private void Update()
    {
        // Считаем значение кубика если но на поверхности и не движется
    ...
    // Проверка коллайдера кубика на столкновение с коллайдером поверности
